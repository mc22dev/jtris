...
from .core_utils import is_valid_position, play_sound # Added import
...
def spawn_piece_at_start(): # Removed is_valid_position_func, play_sound_func
    """Spawns a new piece at the starting position."""
    # Uses Piece from .piece, GRID_WIDTH from .constants
    # Piece class now handles its own utility function imports if needed internally.
