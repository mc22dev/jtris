...
class Piece:
    def __init__(self, x, y, shape_type=None, is_valid_position_func=None, play_sound_func=None, piece_set_type="tetris"): # Allow forcing shape_type for next_piece
        ...
        if self.shape_type >= len(current_shapes):
            ...
            # This might happen if shape_type was for tetris (0-6) but piece_set_type is pentomino (0-11)
